<h1 align="center">こんにちは、クオン・リンです</h1>
...
<h3>私はホーチミン市のVNU-HCM UIT（情報技術大学）の学生で、美しいウェブサイトを開発することに情熱を持っています。</h3>

- 🌱 現在学んでいること: **AngularとMongoDB**
- 🎯 将来の目標: **フルスタック開発やモバイル開発をさらに深く掘り下げる**
- 🎨 コーディング以外では: **テックブログや本を読むこと、料理、ピアノを弾くことが好きです**
- 📫 連絡先: **cuonglinh.ng@gmail.com**
  
✨ お互いに何かを学び合えることを願っています ✨
<hr>

<h3 align="left">使用言語とツール:</h3>
